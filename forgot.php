...
if(isset($_POST['email']))
{
	...
	if(mysql_num_rows($query) > 0){
		...
		mysql_query("UPDATE user SET psw = '".md5(md5($password))."', hash = '".$hash."' WHERE id = '".$data['id']."'");
				...
				<form method="post" novalidate action="">
			    	...
			    	<div class="margined-line-34">
				    	<div class="row-fluid">
					    	...
					    	<div class="width356">
								Для восстановления пароля укажите свой адрес электронной почты. Пароль для входа будет выслан на email.
					    	</div>
				    	</div>
			    	</div>
			    	...
			    	<div class="margined-line-34">
				    	<div class="clearfix padded-top-25">
					    		<div class="pull-right">
									<input id="submit" name="submit" class="btn btn-primary" type="submit" value="Восстановить пароль" />
					    		</div>
					    	</div>
			    	</div>
				</form>
